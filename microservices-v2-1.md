...
(4) Check if you have the right repository url in /spring-cloud-config-server/src/main/resources/application.properties - spring.cloud.config.server.git.uri=file:///hanil/git/spring-micro-services/03.microservices/git-localconfig-repo
...
#### /limits-service/src/main/java/com/hanil/microservices/limitsservice/bean/Limits.java New

```java
package com.hanil.microservices.limitsservice.bean;
...
#### /limits-service/src/main/java/com/hanil/microservices/limitsservice/controller/LimitsController.java New

```java
package com.hanil.microservices.limitsservice.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RestController;

import com.hanil.microservices.limitsservice.bean.Limits;
...
#### /limits-service/src/main/java/com/hanil/microservices/limitsservice/configuration/Configuration.java New

```java
package com.hanil.microservices.limitsservice.configuration;
...
#### /limits-service/src/main/java/com/hanil/microservices/limitsservice/controller/LimitsController.java Modified
...
import com.hanil.microservices.limitsservice.bean.Limits;
import com.hanil.microservices.limitsservice.configuration.Configuration;
...
#### /spring-cloud-config-server/src/main/java/com/hanil/microservices/springcloudconfigserver/SpringCloudConfigServerApplication.java Modified
...
spring.cloud.config.server.git.uri=file:///hanil/git/spring-microservices-v2/03.microservices/git-localconfig-repo
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CurrencyExchange.java New

```java
package com.hanil.microservices.currencyexchangeservice;
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CurrencyExchangeController.java New
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CurrencyExchange.java Modified 
...
- Complete debugging guide for problems with JPA and Hibernate: https://github.com/hanil/hanil-initiatives/blob/master/The-hanil-TroubleshootingGuide-And-FAQ/jpa-and-hibernate.md#tables-are-not-created
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CurrencyExchangeController.java Modified
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CurrencyExchangeRepository.java New
...
```java
package com.hanil.microservices.currencyconversionservice;
...
(1) Ensure that you have the annotation @EnableFeignClients with right packages on the class public class CurrencyConversionServiceApplication @EnableFeignClients("com.hanil.microservices.currencyconversionservice")
...
#### /currency-conversion-service/src/main/java/com/hanil/microservices/currencyconversionservice/CurrencyExchangeProxy.java New
...
#### /currency-conversion-service/src/main/java/com/hanil/microservices/currencyconversionservice/CurrencyExchangeProxy.java Modified
...
#### /api-gateway/src/main/java/com/hanil/microservices/apigateway/ApiGatewayConfiguration.java New

```java
package com.hanil.microservices.apigateway;
...
#### /api-gateway/src/main/java/com/hanil/microservices/apigateway/LoggingFilter.java New
...
#### /currency-exchange-service/src/main/java/com/hanil/microservices/currencyexchangeservice/CircuitBreakerController.java New
...
- (5 Docker Compose Backup Files)[https://github.com/hanil/spring-microservices-v2/tree/main/04.docker/backup]
